...
const char* mntpnt_pw = "LangkastrupXX";
const char* mntpnt = "Langkastrup";

#include <WiFi.h>
//#include "secrets.h"
WiFiClient client;
//WiFiServer directPort(2121);
...
const char * ntrip_server_name = "Langkastrup";
  ...
  while (Serial.available() == 0)
  {
    ...
    if (client.connected() == true)
    {
      ...
      while (1)
      {
       ...
       // if (directPort.hasClient())
       // {
         // Serial.println("DirectPort connected!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
         // if (directPort.available()) 
       //   {             // if there's bytes to read from the client,
          //  char c = directPort.read();             // read a byte, then
          //  Serial.write(c);        //Echo to serial port
       //   }
     // }
